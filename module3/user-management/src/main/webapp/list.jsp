...
<p>
    ...
    <a class="btn btn-primary" href="/productServlet?action=sort" role="button">Sort by name</a>
</p>
...
<table class="table table-hover">
            ...
            <c:forEach items="${list}" var="s" varStatus="loop">
                ...
                <td><c:out value="${s.quantily}"/></td>
                <td><c:out value="${s.color}"/></td>
                <td><c:out value="${s.description}"/></td>
                <td><c:out value="${s.category}"/></td>
<%--                <td><a href="/productServlet?action=edit&id=${s.id}">Edit</a></td>--%>
                <td>
                    <a class="btn btn-primary" href="/productServlet?action=edit&id=${s.code}" role="button">Edit</a>
                </td>
