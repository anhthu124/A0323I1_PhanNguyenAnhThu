...
public class ReadAndWrite {
    public List<DanhBa> ReadFile(){
        ...
        try(BufferedReader bufferedReader=new BufferedReader(new FileReader("src/a/dât/data"))){
            String line=null;
    ...
    public void WriteFile(List<DanhBa>danhBas, boolean b){
        try(BufferedWriter bufferedWriter=new BufferedWriter(new FileWriter("src/a/dât/data"))){
