...
public class ReadAndWrite {
    public List<DanhBa> ReadFile(){
        ...
        try(BufferedReader bufferedReader=new BufferedReader(new FileReader("D:\\Skill\\codegym\\model\\modul2\\modul2\\src\\a\\data\\contacts.csv"))){
            String line=null;
    ...
    public void WriteFile(List<DanhBa>danhBas, boolean b){
        try(BufferedWriter bufferedWriter=new BufferedWriter(new FileWriter("D:\\Skill\\codegym\\model\\modul2\\modul2\\src\\a\\data\\contacts.csv"))){
