...
<div style="display: block">
    <nav class="navbar navbar-light bg-light justify-content-between">
        <li class="nav-item" style="padding: 25px; list-style: none; display: flex">
            <a class="navbar-brand" > Thông tin bệnh nhân</a>
            <a class="btn btn-primary" href="/benhNhanServlet?action=create" style="">Thêm bệnh nhân</a>
        </li>
        <form method="post" action="/benhNhanServlet?action=search" class="d-flex" role="search" style="margin-right: 40px">
...
<table id="tableBenhNhan"  class="table table-striped table-hover">
    <thead>
    <tr>
        ...
        <tr>
            ...
            <td>
                <div style="text-align: center" style=" display:flex; align-items: center; justify-content: space-between">
                    <a class="btn btn-primary" href="/benhNhanServlet?action=edit&id=${c.getId()}" role="button" style="margin-right: 5px" >Edit</a>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="/benhNhanServlet?action=delete">
